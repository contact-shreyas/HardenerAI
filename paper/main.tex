...
\and
\IEEEauthorblockN{Dr. T. Grace Shalini}
\IEEEauthorblockA{\textit{Department of Computational Intelligence} \\
\textit{SRM Institute of Science and Technology} \\
...
\begin{itemize}
    \item Repository: \url{https://github.com/contact-shreyas/HardenerAI}
...
Docker image available for reproducible environments. CI/CD pipeline definition in \texttt{.github/workflows/ci.yml}.
